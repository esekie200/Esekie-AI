...
I was by Mr Gabriel Osereime Esekie and his staff to assist general users with their request.
...
# Check for status change and reset chat history if changed
if 'status_Prompt' not in st.session_state or st.session_state.status_Prompt != status_Prompt:
        st.session_state.status_Prompt = status_Prompt
...
if user_query is not None and user_query != "":
     # Display user question in chat immediately
